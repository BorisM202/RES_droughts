...
\subsection{Wind and PV Capacity \& Availability}
\label{sec:eirgrid}
...
\begin{figure}[!ht]
	...
	\caption{Wind CF density plot of the observed CF (vertical axes) and modelled (horizontal axes) CF data for the Atlite  (left), C3S-E G (centre) and C3S-E N (right) models}
...
\begin{table}[!ht]
	...
	\end{tabular}
	\caption{Skill scores for wind for the three datasets compared to observed data}
...
\begin{figure}[!ht]
	...
	\caption{Average annual number of wind drought events for Atlite (red), C3S-E G (blue), C3S-E N (purple), and the observed data (black outline). The time series are obtained with a time series of the capacity from 2014 to 2023}
...
\begin{figure}[h!]
	...
	\caption{PV 2D density plot of the observed (vertical axes) and modelled (horizontal axes) CF series for the Atlite  (a), C3S-E G (b) and C3S-E N (c) models}	
