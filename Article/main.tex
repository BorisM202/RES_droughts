...
\begin{figure}[!ht]
	...
	\caption{Average annual number of wind drought events for Atlite (red), C3S-E G (blue), C3S-E N (purple), and observed (black outline). The time series are obtained with a time series of the capacity from 2014 to 2023}
...
\begin{figure}[!ht]
	...
	\caption{Number of PV drought events for Atlite (red), C3S-E G (blue), and C3S-E N (purple) and observed (black outline) during 2023}
