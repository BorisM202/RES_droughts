...
\textcolor{cyan}{Which one do you prefer ?}

\begin{figure}[!ht]
	\centering
	\includegraphics[width=\textwidth]{verification_wind_bar2}
	\caption{Average annual number of wind drought events for EirGrid (black), Atlite (red), C3S-E G (blue), and C3S-E N (purple)}
	\label{fig:bar_number_events_verification_wind2}
\end{figure}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=\textwidth]{verification_pv_bar2}
	\caption{Annual number of PV drought events for EirGrid (black), Atlite (red), C3S-E G (blue), and C3S-E N (purple) in 2023}
	\label{fig:bar_number_events_verification_pv2}
\end{figure}
