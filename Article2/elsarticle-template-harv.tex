...
%%Research highlights
\begin{highlights}
\item Energy droughts are defined as periods of low production

\item Three models compared to evaluate renewable energy droughts in Ireland

\item Analysis of 45 years of ERA5 weather data for energy drought trends

\item Diverse energy mix reduces drought frequency and duration significantly

\item Model choice impacts energy drought results
\end{highlights}
