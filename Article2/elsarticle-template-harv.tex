...
\author[Math]{Boris Morin \corref{cor1}} %% Author name
...
\cortext[cor1]{Correponding author}
...
%%Research highlights
\begin{highlights}
\item The C3S-Energy dataset provides renewable energy capacity factor time series

\item Two C3S-Energy and one custom models are compared to assess RES droughts in Ireland

\item RES drought trends are explored by analysing 45 years of ERA5 weather data

\item Diverse energy mix reduces RES drought frequency, duration and extremes

\item Model selection is crucial in the accurate identification of RES droughts
